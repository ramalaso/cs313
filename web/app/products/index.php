 ...
 switch ($action) {
     case 'add-product':
      ...
      case "update":
        ...
        if($itemid != "")
        {
            $sku = filter_input(INPUT_POST, 'edit-sku', FILTER_SANITIZE_STRING);
            $image_product = filter_input(INPUT_POST, 'edit-image', FILTER_SANITIZE_STRING);
            $product_name = filter_input(INPUT_POST, 'edit-name', FILTER_SANITIZE_STRING);
            $quantity = filter_input(INPUT_POST, 'edit-quantity', FILTER_SANITIZE_NUMBER_INT);
            $price = filter_input(INPUT_POST, 'edit-price', FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
            $product_description = "Fruit";
            $db = connect();
